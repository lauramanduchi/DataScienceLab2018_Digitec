...
'''
def conditional_entropy(question, answer, product_set, traffic_set, purchased_set): #laura purchased_set deleted
...
def mutual_inf(question, product_set, traffic_set, purchased_set):
    ...
    for answer in answer_set:
        short_mutual_info += - prob_answer(answer, question, product_set, traffic_set)* \
                             conditional_entropy(question, answer, product_set, traffic_set, purchased_set)
...
def max_info_algorithm(product_set, traffic_set, purchased_set, threshold, y):
    ...
    while not (len(distinct_products) < threshold or len(question_set) == 0):     #laura
        ...
        product_set, traffic_set, purchased_set = algo_utils.select_subset(question=question, answer=answer, product_set=product_set,
